...
import { experience, talks } from "../data/userData";
import CTA from "./CTA";
  ...
  return (
    <div>
      <div class="container px-5 py-24 mx-auto text-white">
        ...
        <div class="container px-5 mt-24 sm:mt-12 sm:py-24 mx-auto">
          <div class="flex flex-col text-center w-full mb-20">
            <h1 class="sm:text-4xl text-3xl font-medium mb-4">Volunteering</h1>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-300 font-medium">
              I love working with communities and have gained some experience
              while contributing to my local developer communities like
              Developer Student Clubs and Google Developer Groups
            </p>
          </div>
          <div class="flex flex-wrap">
            {experience.map((role) => (
              <div class="xl:w-1/2 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
                <div className="flex">
                  <div>
                    <img src={role.link} alt="" className="w-12 h-12 mr-4" />
                  </div>
                  <div>
                    <h2 class="text-lg sm:text-2xl font-medium title-font mb-2">
                      {role.role}
                    </h2>
                    <p className="text-teal inline-flex items-center mb-4">
                      {role.company}
                    </p>
                  </div>
                </div>
                <p class="leading-relaxed text-base mb-4">{role.description}</p>
                <a class="text-teal inline-flex items-center" href>
                  Learn More
                  <svg
                    fill="none"
                    stroke="currentColor"
        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-col text-center w-full mb-20">
            <h1 class="sm:text-4xl text-3xl font-medium mb-4">Talks</h1>
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-300 font-medium">
              I'm enjoy sharing my knowledge with other developers and providing
              resources to make contributing to open-source more approachable. I
              have spoken about various technologies such as Git/GitHub,
              JavaScript, Google Cloud Platform and Design in various formats
              including in-depth workshops,and conference talks.
            </p>{" "}
          </div>
          <div class="flex flex-wrap -m-4">
            {talks.map((talk) => (
              <div class="p-4 lg:w-1/2">
                <div class="h-full bg-navy px-8 pt-8 pb-8 rounded-lg overflow-hidden relative">
                  <div className="w-full h-60 bg-tealtint mb-8 overflow-hidden object-cover">
                    <iframe
                      src={talk.embedLink}
                  ...
                  <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1 uppercase">
                    {talk.community} - {talk.date}
                  </h2>
                  <h1 class="title-font sm:text-2xl text-xl font-medium mb-3">
                    {talk.title}
                  </h1>
                  <p class="leading-relaxed mb-3">{talk.description}</p>
                  <a
                    href={talk.slidesLink}
                    class="text-teal inline-flex items-center"
                  >
                    See Slides
                    <svg
                      class="w-4 h-4 ml-2"
